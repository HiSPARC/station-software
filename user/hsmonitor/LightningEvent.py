...
class LightningEvent(object, Event):
    ...
    def parseMessage(self):
        ...
        self.correctedDistance = int(tmp[1])
        self.uncorrectedDistance = int(tmp[2])
        self.uncorrectedAngle = float(tmp[3])
        self.correctedAngle = float(tmp[4])
