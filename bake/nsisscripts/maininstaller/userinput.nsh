...
# Feb 2019: - Replaced $HasHiSPARC by $HasDAQ
#
#########################################################################################
...
# Read the settings
  ${If} $0 == "success"
    ReadINIStr $HasDAQ        "$PLUGINSDIR\userinput3.ini" "Field 2" "State"
    ReadINIStr $HasWeather    "$PLUGINSDIR\userinput3.ini" "Field 3" "State"
