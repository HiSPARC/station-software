...
3. Unzip all files from the .zip folder that you have downloaded to the required location.

4. FT_PROG requires Microsoft .NET Framework 4.0 installed on your system to run.  This can be obtained from the Microsoft website: http://www.microsoft.com/downloads/en/details.aspx?FamilyId=333325fd-ae52-4e35-b531-508d977d32a6&displaylang=en
Download and follow the wizard for installing .NET 4.0 if you do not have this already installed on your system. 
