# -*- coding: utf-8 -*-
#
# HiSPARC software documentation build configuration file, created by
...
htmlhelp_basename = 'HiSPARCsoftwaredoc'
...
latex_documents = [
  ('index', 'HiSPARCsoftware.tex', u'HiSPARC Software Documentatie',
   u'David Fokkema, Arne de Laat en Bob van Eijk', 'manual'),
]
